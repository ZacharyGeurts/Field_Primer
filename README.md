...
| **[Creditor tributes](https://zacharygeurts.github.io/Field_Primer/creditors/)** | One page per researcher who prompted us |
| **[Gallery](https://zacharygeurts.github.io/Field_Primer/gallery.html)** | Figures & portraits |
...
This repository builds the site above. For prose, chapters, and the illustrated edition — **use the website**, not this README.
...
<details>
<summary>Repo maintainers — rebuild site</summary>
